                    ...
                    <form action="#" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-col items-center text-center">
                                <div class="ep-profile-image">
                                    <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Profile"
                                        class="ep-profile-img" id="ep-profilePreview">
                                    <div class="ep-upload-btn"
                                        onclick="document.getElementById('ep-profileInput').click()">
                                        <i class="fas fa-camera"></i>
                                    </div>
                                    <input type="file" id="ep-profileInput" class="hidden" accept="image/*"
                                        onchange="previewProfileImage(this)">
                                </div>
                                <p class="text-xs text-gray-400 mt-3">Click on camera icon to change profile picture
                                </p>
                        ...
                        <div class="bg-white rounded-3xl p-7 border border-gray-100 shadow-md mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    <label class="ep-form-label"><i class="fas fa-user mr-2 text-brand"></i>First
                                        Name</label>
                                    <input type="text" class="ep-form-input" name="first_name" value="Ashish"
                                        placeholder="First Name">
                                </div>
                                <div>
                                    <label class="ep-form-label"><i class="fas fa-user mr-2 text-brand"></i>Last
                                        Name</label>
                                    <input type="text" class="ep-form-input" name="last_name" value="Rajput"
                                        placeholder="Last Name">
                                </div>
                                <div>
                                    <label class="ep-form-label"><i class="fas fa-envelope mr-2 text-brand"></i>Email
                                        Address</label>
                                    <input type="email" class="ep-form-input" name="email"
                                        value="rajputashish1751@gmail.com" readonly>
                                </div>
                                <div>
                                    <label class="ep-form-label"><i
                                            class="fas fa-at mr-2 text-brand"></i>Username</label>
                                    <input type="text" class="ep-form-input" name="username" value="ashu108108"
                                        placeholder="Username">
                                </div>
                                <div>
                                    <label class="ep-form-label"><i
                                            class="fas fa-phone-alt mr-2 text-brand"></i>Contact
                                        Number</label>
                                    <input type="tel" class="ep-form-input" name="contact_number"
                                        value="7217511751" placeholder="Contact Number">
                                </div>
                                <div class="md:col-span-2">
                                    <label class="ep-form-label"><i
                                            class="fas fa-map-marker-alt mr-2 text-brand"></i>Address</label>
                                    <textarea class="ep-form-textarea" name="address" placeholder="Your address">Vill & post Gajraula shiv</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-3xl p-7 border border-gray-100 shadow-md mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <select class="ep-form-select" name="country">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="ep-form-input" name="city" value="Altıağac"
                                        placeholder="City">
                                </div>
                                <!-- <div>
                                    <label class="ep-form-label"><i
                                            class="fas fa-building mr-2 text-brand"></i>State</label>
                                    <input type="text" class="ep-form-input" name="state" value="South Australia"
                                        placeholder="State">
                                </div> -->
                            </div>
                        </div>
