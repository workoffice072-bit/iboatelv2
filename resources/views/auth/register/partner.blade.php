                ...
                <div class="form-card bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-100 overflow-hidden animate-fade-up"
                    ...
                    <div class="bg-gradient-to-r from-brand to-brand-dark p-6 text-white">
                        <div class="flex items-center gap-5 flex-wrap">
                            ...
                            <div class="flex-1">
                                <h3 class="font-bold text-xl">Register as a Partner</h3>
                                <p class="text-brand-light text-sm mt-1">Become an iBoatel partner! Know boat owners?
                                    Introduce iBoatel to them. Once they register their boats on our platform, you'll
                                    earn 1% commission on every deal from your fleet.</p>
                            </div>
                    ...
                    <!-- Form -->
                    <form class="p-8 md:p-10" method="POST" id="owner_form" action="{{ route('partner.register') }}"
                        ...
                        <div class="mb-8">
                            ...
                            <x-country-state-city prefix="partner" />
                        </div>
                        ...
                        <div class="pt-5 border-t-2 border-gray-100">
                            <div class="flex items-start gap-3 mb-6">
                                ...
                                <label for="terms" class="text-sm text-gray-600">I agree to the <a href="#"
                                        class="text-brand hover:underline font-medium">Terms of Service</a> and <a
                                        href="#" class="text-brand hover:underline font-medium">Privacy
                                        Policy</a>.</label>
                            </div>
