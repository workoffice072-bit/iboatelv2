<x-guest-layout>
    <section class="font-inter bg-gradient-to-br from-[#f0f7fc] to-[#e8f2f8] min-h-screen relative">
        <!-- Background Circles -->
                ...
                <div class="form-card bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-100 overflow-hidden animate-fade-up"
                    ...
                    <div class="bg-gradient-to-r from-brand to-brand-dark p-6 text-white">
                        <div class="flex items-center gap-5 flex-wrap">
                            ...
                            <div class="flex-1">
                                <h3 class="font-bold text-xl">Register as a Boat Owner</h3>
                                <p class="text-brand-light text-sm mt-1">Welcome to iBoatel, use our worldwide access to
                                    put your boat for rent or for sale. You will be directly in touch with customers.
                                </p>
                            </div>
                    ...
                    <!-- Form -->
                    <form class="p-8 md:p-10" method="POST" id="owner_form" action="{{ route('owner.register') }}"
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div class="group">
                                    ...
                                    <input type="text" name="dob" id="owner_dob"
                            ...
                            <div class="group mt-5">
                                ...
                                <x-image-upload-preview prefix="owner" name="profile_photo" label="Profile Photo" />
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <x-country-state-city prefix="owner" />
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="description" rows="3" class="w-full px-4 py-3 rounded-xl bg-gray-50/50 resize-none"
                                placeholder="Tell us about yourself and your boat..."></textarea>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <x-strong-password prefix="owner" />
                        </div>
