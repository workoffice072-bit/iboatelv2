        ...
        <div class="max-w-[1600px] mx-auto px-5 md:px-8 py-[130px] md:py-[50px] flex flex-col lg:flex-row gap-8">
            ...
            <aside class="yc-desktop-sidebar lg:w-[330px] flex-shrink-0 space-y-5">
                ...
                <div
                    ...
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-brand/8 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl">
                    </div>
                    <div class="relative z-10">
                        ...
                        <div class="space-y-4">
                            <div class="relative">
                                ...
                                <div class="relative">
                                    <i
                                        class="fas fa-globe-americas absolute left-4 top-1/2 -translate-y-1/2 text-brand/50 text-sm"></i>
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    <i
                                        class="fas fa-anchor absolute left-4 top-1/2 -translate-y-1/2 text-brand/50 text-sm"></i>
                            ...
                            <div class="flex items-center gap-2 my-2">
                                <div class="flex-1 h-px bg-gradient-to-r from-transparent via-brand/20 to-transparent">
                                </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    <i
                                        class="fas fa-calendar-week absolute left-4 top-1/2 -translate-y-1/2 text-brand/50 text-sm"></i>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-2">
                                    <span class="text-xs font-semibold text-gray-600"><i
                                            class="fas fa-ruler-combined text-brand text-xs mr-1"></i> Boat
                                        length</span>
            ...
            <main class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    ...
                    <a href="{{ route('yeachtchater_details') }}">
                        <div
                            ...
                            <div class="relative h-52 overflow-hidden">
                                ...
                                <div
                                    class="absolute bottom-3 left-3 bg-black/50 backdrop-blur-sm px-2 py-0.5 rounded-full">
                            ...
                            <div class="p-4">
                                <div class="flex justify-between items-start mb-1">
                                    ...
                                    <span
                                        class="text-xs text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full">1995</span>
                                </div>
                        ...
                        <div
                            ...
                            <div class="p-4">
                                <div class="flex justify-between items-start mb-1">
                                    ...
                                    <span
                                        class="text-xs text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full">2022</span>
                                </div>
                                <div class="flex items-center gap-2 mb-3">
                                    <span
                                        class="text-[11px] font-semibold bg-gray-100 text-brand-dark px-3 py-1 rounded-full"><i
                        ...
                        <div
                            ...
                            <div class="p-4">
                                <div class="flex justify-between items-start mb-1">
                                    ...
                                    <span
                                        class="text-xs text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full">2021</span>
                                </div>
                                <div class="flex items-center gap-2 mb-3">
                                    <span
                                        class="text-[11px] font-semibold bg-gray-100 text-brand-dark px-3 py-1 rounded-full"><i
                        ...
                        <div
                            ...
                            <div class="p-4">
                                <div class="flex justify-between items-start mb-1">
                                    ...
                                    <span
                                        class="text-xs text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full">2023</span>
                                </div>
                                <div class="flex items-center gap-2 mb-3">
                                    <span
                                        class="text-[11px] font-semibold bg-gray-100 text-brand-dark px-3 py-1 rounded-full"><i
